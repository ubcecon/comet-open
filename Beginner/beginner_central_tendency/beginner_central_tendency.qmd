...
answer_1 <- 54482.52 # your answer for the mean here
answer_2 <- 43000 # your answer for the median here
...
-   C: mode
```{r}
# use this cell to plot wages
```
```{r}
#| eval: false
#| classes: "question"

answer_3 <- "..." # replace ... with your answer of "A", "B", or "C" here
...
answer_3 <- "B" # replace X with your answer of A, B, or C here

test_3()
```

[Explain your reasoning here:]{style="color: red;"}
...
IQR(census_data$wages)

answer_4 <- IQR(census_data$wages) # your answer here
...
answer_6 <- "50 to 54 years" # replace X and Y for your answer to the age group ranging from X to Y here

test_6()
```

[What is the statistical name for this figure? Would other common measures of central tendency be appropriate to report for this question? Answer here:]{style="color: red;"}
...
1.  A `veteran` variable wherein 1 indicates that the individual is a veteran and 0 otherwise\
2.  A `education` variable where there are distinct categories (i.e. High School Education, Bachelor's Degree, Master's Degree, etc...)\
3.  A `height` variable indicating the height of each individual\
4.  A `wealth` variable indicating the net worth of an individual
