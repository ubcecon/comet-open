...
### Test Your Knowledge: Loading data
...
**Cleaning** our dataset might look like:
...
### Test your Knowledge: Creating new variables
...
Notice that our new varible `has_kids` is not a factor variable. We must add on the appropriate line of codes to make it a factor.

### Test your knowledge: Factorize `has_kids`
...
answer_3 <- class(census_data$has_kids)
...
> **To keep in mind:** To assign a default value on all cases that don't match your specified conditions, use TRUE as your last 'case'. This works because the condition TRUE will always be met if none of the previous conditions are.


### Test your knowledge: Creating Dummy Variables
