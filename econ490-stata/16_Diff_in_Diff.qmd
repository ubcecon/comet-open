...
Let's start by loading our data and letting Stata know that it is a panel data with panel variable *workerid* and time variable *year*. You will remember that we have seen how to do this in [Module 15](https://comet.arts.ubc.ca/docs/econ_490/econ490-stata/15_Panel_Data.html). 
...
Next, we plot the trend of average earnings by each group. Remember that we have seen how to make graphs in [Module 9](https://comet.arts.ubc.ca/docs/econ_490/econ490-stata/9_Stata_Graphs.html).
...
Let's load our fake dataset again and estimate a TWFE model step-by-step.
