...
Let's take a look at our data by using the `browse` command we learned in [Module 5](https://comet.arts.ubc.ca/docs/econ_490/econ490-stata/5_Opening_Datasets.html).
