...
<!-- This project is **open-source** with a mixture of licenses: however, the most restrictive is **CC-BY-SA NC**.  This means that in general you can use and adapt this project for your own teaching or learning provided:-->

This project will be **open-source** with a mixture of licenses: however, right now it's *still copyrighted*.  The most restrictive open license is **CC-BY-SA NC**.  If you want to use to adapt this project, please let us know.  A minimum requirement will be that you:
