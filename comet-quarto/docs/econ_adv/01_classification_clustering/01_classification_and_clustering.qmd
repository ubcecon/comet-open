---
title: "ECON 490: Classification and Clustering Models"
author: COMET Team (Colby Chambers, Jonathan Graves)
date: 18 October 2022
description: "This notebook is an introduction to classification and clustering, two basic unsupervised learning models.  It also includes an introduction to algorithmic bias, using a real-world dataset on criminal recidivism."
categories: [advanced, clustering, classification, machine learning, algorithmic bias]
image: ../../../media/comet_favicon.png
jupyter: ir
execute: 
    keep-ipynb: true
    eval: true
...
raw_data <- read.csv("https://github.com/propublica/compas-analysis/raw/master/compas-scores-two-years.csv")
...
* James, G., Witten, D., Hastie, T., & Tibshirani, R. [_An Introduction to Statistical Learning: With Applications in R._](https://www.statlearning.com/) (2nd Ed.), Springer Texts in Statistics, 2021.
* Angwin, J., Larson, S., Mattu, S., & Kirchner, L. (23 May 2016) [Machine Bias](https://www.propublica.org/article/machine-bias-risk-assessments-in-criminal-sentencing).  _Propublica_.  Retrieved 18 October 2022. 
  * [Link to Propublica Data](https://github.com/propublica/compas-analysis)
