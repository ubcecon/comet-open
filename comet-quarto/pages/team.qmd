...
#title-block-banner: "../media/banner_1.png"
filters:
  - collapse-callout
collapse-callout:
  note: true
...
![](../media/banner_1.png){fig-alt="COMET project banner"}
...
* The [UBC TLEF](https://tlef.ubc.ca/) team, especially Jeff Miller and Jason Myers.
* The team behind [QuantEcon](https://quantecon.org/), especially Jesse Perla and Peifan Wu for their advice and support.
* The [UBC CTLT](https://ctlt.ubc.ca/), [Arts ISIT](https://isit.arts.ubc.ca/), and [LT Hub](https://lthub.ubc.ca/) Teams, for their support with Jupyter and GitLab, especially Stephen Michaud, Nausheen Shafiq, and Michael Ha.
