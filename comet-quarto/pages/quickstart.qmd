...
1.  Choose a **JupyterHub** to launch the COMET service on.  We currently support three options:
    ...
    b.  *[PIMS'](https://www.pims.math.ca/) Syzygy* for UBC-affiliates and others
...
* Other hubs may need to [install packages](installing_locally.qmd#installing-packages) for some notebooks.
:::
...
You're all ready to go!  You can see more details in our [using COMET guide.](installing_locally.qmd)
...
1.  [Install Jupyter or RStudio locally](installing_locally.qmd#installing-jupyter-on-your-own-computer-sec-local) on your own computer, including R and any other packages necessary.
