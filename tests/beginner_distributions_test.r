...
qmd_path <- "../comet-quarto/docs/Beginner/beginner_distributions/beginner_distributions.qmd"
qmd <- parse_rmd(qmd_path)

census_data <- read_dta("../comet-quarto/docs/Beginner/datasets_beginner/01_census2016.dta")

source("../comet-quarto/docs/Beginner/beginner_distributions/beginner_distributions_tests.r")
