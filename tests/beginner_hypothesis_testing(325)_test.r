...
qmd_path <- "../comet-quarto/docs/Beginner/beginner_hypothesis_testing(325)/beginner_hypothesis_testing(325).qmd"
answer_nodes <- parse_rmd(qmd_path)

source("../comet-quarto/docs/Beginner/beginner_hypothesis_testing(325)/beginner_hypothesis_testing(325)_tests.r")
