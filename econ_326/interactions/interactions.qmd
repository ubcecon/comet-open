...
:::{.answer}
Answer: $\beta_5$ is the difference of 'value-added' of education between female-lead household and male-lead household. $\beta_6$ is the difference of province effects between female-lead household and male-lead household.
...
:::{.answer}
Answer: It means if the main earner is a female with a university degree, the household accumulates 302,008 dollars less wealth, than the male counterpart.

University degree holders are most discriminated, because $|\hat{\beta_5}|$ is higher than $|\hat{\beta_2}|$.
...
:::{.answer}  
Answer:
Yes, these regression estimates support my argument from question 5. First of all, for both male-lead and female-lead households, incomes increase as main earners become older, and the peak appears at their 50s. Second, there is a gender-wage gap in which female-lead households earn less. But the gap changes as age changes.
:::
...
:::{.answer}  
Answer:
The result cannot represent the whole Canada, because participants were from a neighborhood in Vancouver.
:::
