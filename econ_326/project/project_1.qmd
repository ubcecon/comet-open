...
mlr_3 <- lm(CO2 ~ gdp + population + electricity, data = CO2_data)

# Obtain robust standard errors
robust_se <- sqrt(diag(vcovHC(mlr_3, type = "HC1")))  # "HC1" is one of the robust variance estimators
...
In the final model the relationships appear to be significant. We would interpret... However this model is still severely affected by multicollinearity. 
