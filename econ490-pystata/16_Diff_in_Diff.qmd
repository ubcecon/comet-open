...
Let's start by loading our data and letting Stata know that it is a panel data with panel variable *workerid* and time variable *year*. You will remember that we have seen how to do this in [Module 14](https://comet.arts.ubc.ca/docs/econ_490/econ490-stata/14_PostReg.html). 
