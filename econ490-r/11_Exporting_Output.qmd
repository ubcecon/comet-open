...
Then we can estimate our regression using the function `lm`. We have seen how to do it in [Module 10](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/10_Linear_Reg.html).
