...
Let's do this step by step. We start by creating the data: we want a dataframe with average earnings by year and treatment status for the first two regions. We use `group_by`, as seen in [Module 6](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/6_Within_Group.html).
...
Once we have created our data, we proceed with the same steps we have used in section 8.2.2 of [Module 8](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/8_ggplot_graphs.html) to create a line plot with one line for each treatment status (*treated* and *untreated*).
...
As we have seen in [Module 8](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/8_ggplot_graphs.html), we usually use histograms to represent density distributions and we can use a scatterplot or a line plot for the graph of earnings over time. 
...
Start with the histogram: use `geom_histogram` to create a histogram for the density of log-earnings and store it into the object *plot1*. You can find a detailed explanation in section 8.2.3 of [Module 8](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/8_ggplot_graphs.html).
...
Then, create a line graph for the average log-earning by year using `geom_line` and store it into the object *plot2*. You can find a detailed explanation in section 8.2.2 of [Module 8](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/8_ggplot_graphs.html).
