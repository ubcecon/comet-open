...
&= E[logearnings_{i} \mid region_{i}=0, age_{i}=0] + \beta_1 \{region_{i}=1\} \\
&+ \beta_2 age_{i} + u_{i}^* - E[logearnings_{i} \mid region_{i}=0, age_{i}=0] \\
&= \beta_0 + \beta_1 \{region_{i}=1\} + \beta_2 age_{i}  + u_{i} \end{align}
