...
categories: [econ 490, loading data, glimpse, summary, cleaning, factorizing, missing data]
format: 
  html: default
  ipynb:
    jupyter:
...
More details on RStudio Projects can be found in [Module 17](https://comet.arts.ubc.ca/docs/econ_490/econ490-r/17_Wf_Guide.html).
