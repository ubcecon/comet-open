...
```
 where instead of `<Y>`, `<X>`, and `<Z>` you have to write the names of the corresponding Y, X, and Z variables of your model, and instead of `<data>` you write the name of your dataframe.
