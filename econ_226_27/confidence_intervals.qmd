---
title: "01 - Introduction to Confidence Intervals using R"
...
categories: [introduction, review, econ 226,econ 227, confidence intervals, inferential statistics, sampling, data, descriptive statistics]
format: 
  html: default
  ipynb:
    jupyter:
...
source("confidence_intervals_tests.R")
```
