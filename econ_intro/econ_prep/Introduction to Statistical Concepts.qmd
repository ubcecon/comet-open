...
![A chart displaying the outcomes included in events A and B.](media/diagrams/events_outcomes1.png){fig-alt="A chart displaying the outcomes included in event A (Chum, Pink) and event B(Chinook, Sockeye, Coho)"}
...
![A chart displaying the outcomes included in events A and B.](media/diagrams/events_outcomes2.png){fig-alt="A chart displaying the outcomes included in event A (Chum , Pink) and event B(Sockeye, Coho, Pink)"}
...
![A venn diagram to help visualize the concept of joint-probability.](media/diagrams/joint_probability.png){fig-alt="A venn diagram of circles A and B, which shows that the joint-probability of events A and B can be visualized as the area of overlap."}
...
![A pair of venn diagrams to help visualize types of unions.](media/diagrams/types_of_unions.png){fig-alt="A pair of venn diagrams representing relationships between events A and B; mutually exclusive events have no area of overlap, whereas non-mutually exclusive events do"}
...
![A pair of venn diagrams to help visualize probability calculations.](media/diagrams/calculating_unions.png){fig-alt="A pair of venn diagrams visualizing the calculation of the probability for union."}
...
![A diagram of fish in a pond, showing how probability changes as the number of a certain type of fish decreases](media/diagrams/fishing_pond.png){fig-alt="A visual of a pond with ten salmon, and the resulting pond of nine salmon after one salmon as been removed."}
...
![A contingency table showing a possible configuration of hatchery and wild salmon caught for two different species](media/diagrams/contingency_table.png){fig-alt="A contingency table; wild Coho = 32, hatchery Coho = 60, total Coho = 92, wild Sockeye = 15, hatchery Sockeye = 50, total Sockeye = 65, total salmon = 157"}
...
![A tree diagram of the possible ways to go on a fishing trip based on the above table.](media/diagrams/tree_diagram1.png){fig-alt="A tree diagram summarizing all 12 possible outcomes fishing trips from the list of options."}
...
![A table showing the possible outcomes for each "spot"](media/diagrams/possible_outcomes.png){fig-alt="A table showing the five possible options of species (Pink, Coho, Sockeye, Chinook, Chum) for each of the five fish caught"}
...
![A tree digram showing all the possible outcomes for a pond with a Pink, Coho, and Chum salmon"](media/diagrams/tree_diagram2.png){fig-alt="A tree diagram showing that there are sie possible outcomes from a pond with this combination of fish"}
...
![A table of sample cross sectional data.](media/diagrams/cross_sectional_data.png){fig-alt="Sample data recording information about participants' age, height, city of residence, etc."}
...
![A table of sample panel data.](media/diagrams/panel_data.png){fig-alt="Sample data recording information about voting turnout and population for two different cities, for multiple years."}
...
![A diagram which shows that the sample is a representation of the population.](media/diagrams/population_sample.png){fig-alt="A diagram displaying how sample data is taken from a larger populuation"}
...
![A table of sample data of the primary reason the polled participants feel concerned about salmon stocks.](media/diagrams/sample_1_data.png){fig-alt="Not concerned = 13, ecosystem/environmental = 44, livelihood = 15, consumption = 28, total = 100"}
...
![Another table of sample data of the primary reason the polled participants feel concerned about salmon stocks.](media/diagrams/sample_2_data.png){fig-alt="For the polled participants, not concerned = 17, ecosystem/environmental = 47, livelihood = 23, consumption = 13, total = 100"}
