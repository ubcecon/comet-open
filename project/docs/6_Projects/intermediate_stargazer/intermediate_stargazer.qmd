...
description: This notebook goes over how to make neat and easily digestible regression and summary statistics tables in R using the `stargazer` package. 
...
table_1 <- stargazer(model_1, model_2, model_3, 
  ...
  keep.stat = c("n","rsq","f"), # residual standard error
  align = TRUE)
```
