...
1.  Create an object `a` which is a draw from the uniform distribution, with 5,000 observations between 10 and 20, using the random seed 20. Store your answer in `answer_1`.
