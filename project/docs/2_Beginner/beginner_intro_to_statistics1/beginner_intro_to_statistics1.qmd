...
answer_1 <- 'true' # your answer here('true' or 'false')
...
![A comparison of two ponds, displaying how the number of permutations changes when there are repetitions in the dataset"](media/diagrams/permutations_repetitions.png){fig-alt="A visualization showing how the number of permutations was is reduced when a repeat of the element (two of the same salmon species) are introduced"}
...
> 2.  How much salmon do you consume in a year \_\_\_\_\_\_\_\_\_ *(grams)*
...
![A diagram which shows that the sample is a representation of the population.](media/diagrams/population_sample.png){fig-alt="A diagram displaying how sample data is taken from a larger population"}
