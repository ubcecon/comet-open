...
Note that numbers 21-25 are shapes that have both fill and outline color options which can be helpful if we are trying to make our data points stand out better.
...
Alternatively, once we have completed and exported a visualization, we can run it through a [Color Blindness Simulator](https://www.color-blindness.com/coblis-color-blindness-simulator/) like this one to test if our visualization looks okay from the perspective of those who have different color blindness or impairment conditions.
...
# filter our data for a subset of African and South American Countries
