...
it's important to get a good grasp of the different **data types** in Python and how to use them.  Whenever we work with Python, we will be manipulating different kinds of information, which is referred to as "data".  Data comes in many different forms, and these forms define how we can use it in calculations or visualizations - these are called _types_ in R.
...
3. Given the matrix below, extract the element on the 30th row and 10th column, store it in an object called `first`. 
4. Extract the element on the 27th row and 13th column, store it in an object called `second`. 
5. Extract the element on the 12th row and 33rd column, store it in an object called `third`. 
