...
We learned the techniques to create a balanced panel in [Module 7](https://comet.arts.ubc.ca/docs/Research/econ490-stata/07_Within_Group.html). Essentially, all that is needed is to create a new data set that includes only the years for which there are no missing values. 
