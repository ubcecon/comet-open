...
![RStudio Project Default Directory](img/fig1.png  "RProject Object")
...
![Main directory structure](img/fig2.png  "Main directory structure")
...
![Scripts folder with example scripts](img/fig3scripts.png "Example scripts")
