...
categories: [introduction, econ 326, simple regression, regression, ols, t-test, dummy variable, pareto distribution, intermediate, R]
format: 
  html: default
  ipynb:
    jupyter:
...
> the model in R and just focus on the variables.
...
By the OLS reggression assumptions, we have that \$E\[\epsilon\_i\|G_i\]
= 0 \$, so:
