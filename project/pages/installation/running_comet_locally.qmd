...
**If you have instructions to build on a specific branch for example local_build_dockerfile then simply replace main with the branch name. The command becomes git switch local_build_dockerfile**
