...
Just looking for a quick overview of how Jupyter notebooks work?  Try out [getting started](../docs/Getting_started/getting_started_intro_to_jupyter/getting_started_intro_to_jupyter.qmd) introduction to Jupyter notebook, then come back here.
:::
...
* For example, you could assign students a pre-reading of [classification and clustering](../docs/Advanced/advanced_classification_and_clustering/advanced_classification_and_clustering.qmd) before class.  In the class, you could then introduce a new dataset and have them explore it using clustering methods.
* Many of our COMET notebooks, especially the [intermediate ones](../docs/Intermediate/intermediate_multiple_regression/intermediate_multiple_regression.qmd) are built with this structure, where one "Part" of the notebook can be turned into the classroom part of the flipped classroom.^[This was actually our original use for the notebooks, before COMET! See @graves2024understanding]
...
* [Word Embeddings](../docs/Advanced/advanced_word_embeddings/Word2Vec_Workshop_Python_Version.ipynb): an advanced, workshop-style, `.ipynb` format notebook.
* [Visualization](../docs/Beginner/beginner_intro_to_data_visualization1/beginner_intro_to_data_visualization1.qmd): a basic, lecture-style, introduction with time for experimentation.
* [Exporting Output](../docs/Research/econ490-stata/12_Exporting_Output.ipynb): a flipped-classroom style book or workshop for STATA output.
