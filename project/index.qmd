...
![](media/single_loop.gif){width="300" fig-align="center" .hero-logo}

::: {.callout-warning}
## Summer 2026 Update

We have recently migrated the COMET project to open-source hosting, here on GitHub.

* You can still use the old URL at [comet.arts.ubc.ca](https://comet.arts.ubc.ca) but be aware that deep links may not work properly.
* We recommend updating all your links to point to the new [ubcecon.github.io/comet-open/](https://ubcecon.github.io/comet-open/) address.

(_Last Update_: 2026-06-03)
:::
